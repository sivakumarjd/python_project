...
def process_event(event: dict) -> dict:
    ...
    decoded_payload = base64.b64decode(event.get("awslogs1").get("data"))
...
def send_email(
    ...
    email_body = f"""
        ...
        Hi Receiver,
            ...
            SG STRAUSS print files are transferred successfuly to ATOS server
    ...
    email_subject = f" PRINT DELIVERY STATUS - | {lambda_function_name}"
